...
Cellule is a TensorFlow Image Classifer that can be used to classify an image of cells and determine whether it is an image of Plant cells or an image of Animal cells.
